...
/**
 * Created by kennybastani on 8/20/14.
 */
public class LearningManager {
    ...
    private static final DataNodeManager dataNodeManager = new DataNodeManager("Data", "value");
    private static final ClassNodeManager classNodeManager = new ClassNodeManager("Class", "name");
     ...
     */
    public static String GetTemplate(String pattern) {
     ...
     */
    public static String GeneratePattern(int i, PatternCount patternCount, String pattern) {
        Pattern generalMatcher = Pattern.compile(GraphManager.WILDCARD_TEMPLATE);
        Matcher regexMatcher = generalMatcher.matcher(pattern);
        StringBuffer s = new StringBuffer();
        int counter = 0;
