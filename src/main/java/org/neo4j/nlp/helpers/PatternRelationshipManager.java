...
public class PatternRelationshipManager {
    ...
    public List<Long> getOrCreateNode(Long start, Long end, GraphDatabaseService db) {
        ...
        if (relList == null) {
            ...
            startNode.setProperty("classes", new HashSet(relList).size());
